...
* Date of the Last Update:  Jan 17, 2012
*
...
#define Q_TRAN(target_)  \
    (((QFsm *)me)->state = Q_STATE_CAST(target_), Q_RET_TRAN)
...
#define Q_SUPER(super_)  \
    (((QHsm *)me)->state = Q_STATE_CAST(super_),  Q_RET_SUPER)


/** \brief Perform downcast of an event onto a subclass of QEvent \a class_
*
* This macro encapsulates the downcast of QEvent pointers, which violates
